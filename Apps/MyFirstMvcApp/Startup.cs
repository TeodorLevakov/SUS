...
namespace BattleCards
{
    public class Startup : IMvcApplication
    {
        ...
        public void Configure(List<Route> routeTable)
        {
            ...
            //routeTable.Add(new Route("/users/register", HttpMethod.Post, new UsersController().DoLogin));
            ...
            //routeTable.Add(new Route("/css/custom.css", HttpMethod.Get, new StaticFilesController().CustomerCss));
            //routeTable.Add(new Route("/js/bootstrap.bundle.min.js", HttpMethod.Get, new StaticFilesController().BootstrapJs));
            //routeTable.Add(new Route("/js/custom.js", HttpMethod.Get, new StaticFilesController().CustomerJs));
            //routeTable.Add(new Route("/img/cat.jpg", HttpMethod.Get, new StaticFilesController().CatJpg));
        }
    }
}

    ...
    public class HttpRequest
    {
        ...
        public HttpRequest(string requestString)
        {
            ...
            if (this.Headers.Any(x => x.Name == HttpConstants.RequestCookieHeader))
            {
                ...
                {
                    this.Cookies.Add(new Cookie(cookieAsStr));
                }
            }
        ...
        private static void SplitParameters(string paramAsString, IDictionary<string, string> output) 
        {
            var parameters = paramAsString.Split(new char[] { '&' }, StringSplitOptions.RemoveEmptyEntries);
